...
ให้ตอบคำถามโดยให้คำตอบกระชับที่สุด\n"""
...
def inference(
    ...
    print(f"{max_input_length=}, {max_output_len=}, {temperature=}")
...
def main(question, knowledge):
    start_time = time.time()
    output_text = inference(question, knowledge, engine_dir="tamtanai_engines_1gpu")
    end_time = time.time()
